 ...
 * @apiNote
 */
public class RubyCommunist extends ToolItem {
    ...
    public RubyCommunist() {
        super(18.5f, -1.5f, ItemTier.NETHERITE, DIGGABLES, new Item.Properties()
                .stacksTo(1)
    ...
    public void appendHoverText(ItemStack stack, @Nullable World world, List<ITextComponent> list, ITooltipFlag flags) {
        list.add(new TranslationTextComponent("message.ruby_communist"));
    }
}
