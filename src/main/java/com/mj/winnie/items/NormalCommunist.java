 ...
 * @apiNote
 */
public class NormalCommunist extends ToolItem {
    ...
    public NormalCommunist() {
        super(16, -1.8f, ItemTier.NETHERITE, DIGGABLES, new Item.Properties()
                .stacksTo(1)
    ...
    public void appendHoverText(ItemStack stack, @Nullable World world, List<ITextComponent> list, ITooltipFlag flags) {
        list.add(new TranslationTextComponent("message.normal_communist"));
    }
}
