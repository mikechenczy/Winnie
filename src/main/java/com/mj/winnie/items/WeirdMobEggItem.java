    ...
    public ActionResultType useOn(ItemUseContext context) {
        ...
        if (world.isClientSide) {
            ...
            if (tileentity instanceof MobSpawnerTileEntity) {
                ...
                abstractspawner.setEntityId(Entities.MAOZEDONGMOB.get());
            ...
            if (Entities.MAOZEDONGMOB.get().spawn((ServerWorld) world, itemstack, context.getPlayer(), blockpos1, SpawnReason.SPAWN_EGG, true, !Objects.equals(blockpos, blockpos1) && direction == Direction.UP) != null) {
                itemstack.shrink(1);
            }
