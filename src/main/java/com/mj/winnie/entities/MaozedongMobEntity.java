...
public class MaozedongMobEntity extends MonsterEntity implements IRangedAttackMob, IChargeableMob {
    private static final DataParameter<Integer> DATA_TARGET_A = EntityDataManager.defineId(MaozedongMobEntity.class, DataSerializers.INT);
    private static final DataParameter<Integer> DATA_TARGET_B = EntityDataManager.defineId(MaozedongMobEntity.class, DataSerializers.INT);
    private static final DataParameter<Integer> DATA_TARGET_C = EntityDataManager.defineId(MaozedongMobEntity.class, DataSerializers.INT);
    private static final List<DataParameter<Integer>> DATA_TARGETS = ImmutableList.of(DATA_TARGET_A, DATA_TARGET_B, DATA_TARGET_C);
    private static final DataParameter<Integer> DATA_ID_INV = EntityDataManager.defineId(MaozedongMobEntity.class, DataSerializers.INT);
    ...
    public MaozedongMobEntity(EntityType<? extends MaozedongMobEntity> p_i50226_1_, World p_i50226_2_) {
    ...
    public boolean hurt(DamageSource p_70097_1_, float p_70097_2_) {
        if (this.isInvulnerableTo(p_70097_1_)) {
            return false;
        } else if (p_70097_1_ != DamageSource.DROWN && !(p_70097_1_.getEntity() instanceof MaozedongMobEntity)) {
    ...
    class DoNothingGoal extends Goal {
        ...
        public boolean canUse() {
            return MaozedongMobEntity.this.getInvulnerableTicks() > 0;
        }
    }
}