...
public class BlockStates extends BlockStateProvider {
    ...
    public BlockStates(DataGenerator gen, ExistingFileHelper exFileHelper) {
        super(gen, Winnie.MODID, exFileHelper);
    }
    ...
    private void registerFirstBlock() {
        ResourceLocation txt = new ResourceLocation(Winnie.MODID, "block/firstblock");
        BlockModelBuilder modelFirstblock = models().cube("firstblock", txt, txt, new ResourceLocation(Winnie.MODID, "block/firstblock_front"), txt, txt, txt);
        BlockModelBuilder modelFirstblockPowered = models().cube("firstblock_powered", txt, txt, new ResourceLocation(Winnie.MODID, "block/firstblock_powered"), txt, txt, txt);
