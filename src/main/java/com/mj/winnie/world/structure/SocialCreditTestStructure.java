...
public class SocialCreditTestStructure extends Structure<NoFeatureConfig> {

    private static final String CATACOMB_START_POOL = "social_credit_test/start_pool";

    public SocialCreditTestStructure() { super(NoFeatureConfig.CODEC); }
