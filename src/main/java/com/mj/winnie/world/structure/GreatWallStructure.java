...
public class GreatWallStructure extends Structure<NoFeatureConfig> {

    private static final String CATACOMB_START_POOL = "great_wall/start_pool";

    public GreatWallStructure() { super(NoFeatureConfig.CODEC); }
