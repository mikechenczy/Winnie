...
public class ProtestorsCage extends Structure<NoFeatureConfig> {

    private static final String CATACOMB_START_POOL = "protestors_cage/start_pool";

    public ProtestorsCage() { super(NoFeatureConfig.CODEC); }
