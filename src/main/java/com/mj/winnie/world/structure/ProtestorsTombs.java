...
public class ProtestorsTombs extends Structure<NoFeatureConfig> {

    private static final String CATACOMB_START_POOL = "protestors_tombs/start_pool";

    public ProtestorsTombs() { super(NoFeatureConfig.CODEC); }
