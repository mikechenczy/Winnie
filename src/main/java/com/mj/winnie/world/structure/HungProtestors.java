...
public class HungProtestors extends Structure<NoFeatureConfig> {

    private static final String CATACOMB_START_POOL = "hung_protestors/start_pool";

    public HungProtestors() { super(NoFeatureConfig.CODEC); }
