...
public class SpawnerScreen extends Screen {
    ...
    private ResourceLocation GUI = new ResourceLocation(Winnie.MODID, "textures/gui/spawner_gui.png");


    public SpawnerScreen() {
        super(new TranslationTextComponent("screen.winnie.spawn"));
    }
